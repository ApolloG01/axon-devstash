...
export async function getCollectionsByUserId(userId: string): Promise<CollectionWithTypes[]> {
  ...
  return collections.map((col) => {
    ...
    const typeCounts = new Map<string, { name: string; color: string; icon: string; count: number }>()
